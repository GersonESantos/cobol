...
001990     IF FS NOT = "00"
      ...
      *---------------------------------------------------------------*
       ...
       LER-PRODUTOS SECTION.
          ...
          MOVE PRATAC-01R TO PRATAC-01RDB
          MOVE UND-01     TO UND-01DB.
          MOVE 98754      TO PRATAC-01RDB.

       GRAVA-PRODUTOS SECTION.
          MOVE COD-01DB   TO COD-01
          MOVE DESC-01DB    TO DESC-01DB
          MOVE PRATAC-01RDB TO PRATAC-01RDB
          MOVE UND-01DB     TO UND-01DB.
