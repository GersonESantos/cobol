      ****************************************************************
      * PROGRAMA 7    *
      *    comunicacao cobol dialog*
      *    Lembrar de mudar SET-BUILD-NO para 11*
      *    *
      *    *
      *    *
      *    *
      ...
      *---------------------------------------------------------------*
       ...
       Program-Body SECTION.
           if num-dbl = 1 move "un do cobo" to camp-dbl.
           if num-dbl = 2 move "dois do cobo" to camp-dbl.
           if num-dbl = 3 move "tres do cobo" to camp-dbl.
           if num-dbl = 9 move 0 to EXIT-FLAG.
